...
# NOTE: The legacy `colr` package is not compatible with newer Python versions
# (e.g. 3.11+). Treat it as optional and fall back to plain text.
try:
    from colr import color  # type: ignore
except Exception:  # noqa: BLE001
    def color(text, *args, **kwargs):  # type: ignore[no-redef]
        return str(text)
...
def main():
    ...
    launch_data = calculate_launch_success(instance_types, zones, profile)
