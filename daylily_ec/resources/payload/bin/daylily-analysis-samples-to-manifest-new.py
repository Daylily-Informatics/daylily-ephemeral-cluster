...
def main(argv=None):
    ...
    if "-h" in argv or "--help" in argv:
        print("Usage: daylily-analysis-samples-to-manifest-new.py <input_tsv> <stage_target>")
        return 0

    if len(argv) != 2:
        log_error("Usage: daylily-analysis-samples-to-manifest-new.py <input_tsv> <stage_target>")

    check_aws_credentials()

    input_file = argv[0]
    stage_target_base = argv[1]
