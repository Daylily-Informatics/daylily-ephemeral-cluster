...
The catalog is version 2. The current DayOA repository default and DayOA command pins are `8.0.0`; `daylily-sarek` is present as a Nextflow/nf-core Sarek repository entry.
