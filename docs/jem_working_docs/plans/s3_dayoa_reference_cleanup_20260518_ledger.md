...
boto3 list_objects_v2 on s3://lsmc-dayoa-omics-analysis-us-west-2/fsx/staging/staged_sample_data/
```
...
|---|---:|---:|---:|---|
| ILMN run 007 assigned staged data | `s3://lsmc-dayoa-omics-analysis-us-west-2/fsx/staging/staged_sample_data/remote_stage_20260516T132807Z/` | 0 | 0 | No S3 objects found. |
...
| ILMN run 007 recovered staged data | `s3://lsmc-dayoa-omics-analysis-us-west-2/fsx/staging/staged_sample_data/recovered_undetermined/` | 0 | 0 | No S3 objects found. |
| ONT PCA100 20260513 staged data | `s3://lsmc-dayoa-omics-analysis-us-west-2/fsx/staging/staged_sample_data/remote_stage_20260517T155831Z/` | 69 | 41,901,872,070 | Live delete candidate. |
| Older ONT example solo staged data | `s3://lsmc-dayoa-omics-analysis-us-west-2/fsx/staging/staged_sample_data/remote_stage_20260424T110647Z/` | 0 | 0 | No S3 objects found. |
| Older ONT example hybrid staged data | `s3://lsmc-dayoa-omics-analysis-us-west-2/fsx/staging/staged_sample_data/remote_stage_20260424T113324Z/` | 0 | 0 | No S3 objects found. |
...
AWS_PROFILE=lsmc AWS_REGION=us-west-2 \
aws s3 rm --recursive \
  s3://lsmc-dayoa-omics-analysis-us-west-2/fsx/staging/staged_sample_data/remote_stage_20260517T155831Z/
```
