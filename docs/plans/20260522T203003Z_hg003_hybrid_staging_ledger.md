...
| ONT hybrid source | Existing reference-bucket CRAM `/fsx/data/genomic_data/organism_reads/H_sapiens/giab/agbt_2026/ont/HG003_30x.cleaned.cram` with `.crai` present. Prior compatibility validation recorded this CRAM as readable against `hg38_broad`. |
...
| Remote stage prefix | `s3://lsmc-dayoa-omics-analysis-us-west-2/data/staged_sample_data/remote_stage_20260522T203135Z/` |
| Headnode stage path for future clusters | `/fsx/data/staged_sample_data/remote_stage_20260522T203135Z/` |
...
| `MAN-001` | `SUCCESS` | Create DayEC analysis manifest for HG003-a ILMN + ONT hybrid staging. | Manifest has 31 tab-separated columns and one data row. `ILMN_R1_FQ` and `ILMN_R2_FQ` each contain 8 comma-separated S3 URIs in lane order; `ONT_CRAM` points to the reference-bucket HG003 30x CRAM visible as `/fsx/data/...`. |
...
- stage dir: `/fsx/data/staged_sample_data/remote_stage_20260522T203135Z/`
- samples TSV: `/fsx/data/staged_sample_data/remote_stage_20260522T203135Z/20260522T203135Z_samples.tsv`
- units TSV: `/fsx/data/staged_sample_data/remote_stage_20260522T203135Z/20260522T203135Z_units.tsv`
