...
LOG_ROOT = PLAN_ROOT / "20260526T223700Z_goodole3_logs_retry1"
EVENTS_PATH = PLAN_ROOT / "20260526T223700Z_goodole3_catalog_runs_retry1.jsonl"
RUN_SUFFIX = "r1"
...
def ensure_stage_mount(command_id: str, remote_stage_dir: str, timeout_seconds: int) -> None:
    ...
    if existing and existing.get("stage_name") == stage_name:
        return
    argv = [
        dyec(),
        "--json",
...
def stage_sample(command_id: str, manifest_name: str, timeout_seconds: int) -> str:
    ...
    remote_stage_dir = f"/home/ubuntu/ds/gd3r1/{command_key}/{stage_name}"
