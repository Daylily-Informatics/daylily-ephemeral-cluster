#!/usr/bin/env python3
"""Run the blahab44 DayOA command-catalog validation matrix.

This is a durable execution helper for the ledger opened at
docs/plans/20260526T224018Z_blahab44_catalog_validation_ledger.md.
"""
...
RUN_ROOT = PLAN_ROOT / "20260526T224018Z_blahab44_inputs"
LOG_ROOT = PLAN_ROOT / "20260526T224018Z_blahab44_logs"
EVENTS_PATH = PLAN_ROOT / "20260526T224018Z_blahab44_catalog_runs.jsonl"
...
SAMPLE_INPUTS = {
    ...
    "illumina_snv_alignstats_relatedness_vep_multiqc": "illumina_hg003_5x.tsv",
...
def safe_id(command_id: str, suffix: str = "") -> str:
    base = f"bb44_{command_id}{suffix}"
...
def stage_sample(command_id: str, manifest_name: str, timeout_seconds: int) -> str:
    ...
    remote_stage_dir = f"/home/ubuntu/ds/bb44/{command_key}/{stage_name}"
