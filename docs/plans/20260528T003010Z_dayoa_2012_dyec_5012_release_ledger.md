...
| DYEC-RELEASE-A | Commit staged DYEC changes, push branch, create annotated tag `5.0.11`, and push tags. | Pending. | OPEN |
| DYEC-SELF-PIN | Update source and packaged DYEC self-pins to final tag `5.0.12`. | Pending. | OPEN |
| DYEC-VALIDATE-B | Validate config parity and focused tests before final release commit. | Pending. | OPEN |
| DYEC-RELEASE-B | Commit final self-pin change, push branch, create annotated tag `5.0.12`, and push tags. | Pending. | OPEN |
