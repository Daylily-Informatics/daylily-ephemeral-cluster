...
for uri in
  s3://lsmc-dayoa-references-usw2/runtime_assets/tool_specific_resources/vep/homo_sapiens/
  s3://daylily-dayoa-references-usw2/runtime_assets/tool_specific_resources/vep/homo_sapiens/
  s3://lsmc-dayoa-control-data-usw2/runtime_assets/tool_specific_resources/vep/homo_sapiens/
  s3://lsmc-dayoa-control-data-usw2/tool_specific_resources/vep/homo_sapiens/
; do
  echo "--- $uri"
