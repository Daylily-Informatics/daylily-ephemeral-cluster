set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r8_inflection-bjuice-product-v0.1_dryrun
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r8_inflection-bjuice-product-v0.1_dryrun/daylily-omics-analysis
echo '=== status ==='
