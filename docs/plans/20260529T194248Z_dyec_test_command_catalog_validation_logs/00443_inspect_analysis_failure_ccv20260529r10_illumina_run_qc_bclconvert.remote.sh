set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r10_illumina_run_qc_bclconvert
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r10_illumina_run_qc_bclconvert/daylily-omics-analysis
echo '=== status ==='
