set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r13_ultima_run_qc
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r13_ultima_run_qc/daylily-omics-analysis
echo '=== status ==='
