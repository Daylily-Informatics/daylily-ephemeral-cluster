set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r14_illumina_bclconvert
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r14_illumina_bclconvert/daylily-omics-analysis
echo '=== status ==='
