set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r6_ultima_snv_alignstats
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r6_ultima_snv_alignstats/daylily-omics-analysis
echo '=== status ==='
