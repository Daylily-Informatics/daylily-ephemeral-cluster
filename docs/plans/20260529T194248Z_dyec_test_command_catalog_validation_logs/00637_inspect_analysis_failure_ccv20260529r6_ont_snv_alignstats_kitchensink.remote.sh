set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r6_ont_snv_alignstats_kitchensink
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r6_ont_snv_alignstats_kitchensink/daylily-omics-analysis
echo '=== status ==='
