set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r15_illumina_bclconvert
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r15_illumina_bclconvert/daylily-omics-analysis
echo '=== status ==='
