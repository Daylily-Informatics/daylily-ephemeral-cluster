set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r36_illumina_hg002_kitchensink_multiqc
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r36_illumina_hg002_kitchensink_multiqc/daylily-omics-analysis
echo '=== status ==='
