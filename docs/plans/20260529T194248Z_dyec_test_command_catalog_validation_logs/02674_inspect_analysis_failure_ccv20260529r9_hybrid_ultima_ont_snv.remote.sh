set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r9_hybrid_ultima_ont_snv
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r9_hybrid_ultima_ont_snv/daylily-omics-analysis
echo '=== status ==='
