set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r7_hybrid_ilmn_ont_snv_kitchensink
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r7_hybrid_ilmn_ont_snv_kitchensink/daylily-omics-analysis
echo '=== status ==='
