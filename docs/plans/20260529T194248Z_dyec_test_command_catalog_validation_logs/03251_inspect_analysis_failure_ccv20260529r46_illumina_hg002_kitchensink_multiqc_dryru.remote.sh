set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260529r46_illumina_hg002_kitchensink_multiqc_dryrun
repo_dir=/fsx/analysis_results/ubuntu/ccv20260529r46_illumina_hg002_kitchensink_multiqc_dryrun/daylily-omics-analysis
echo '=== status ==='
