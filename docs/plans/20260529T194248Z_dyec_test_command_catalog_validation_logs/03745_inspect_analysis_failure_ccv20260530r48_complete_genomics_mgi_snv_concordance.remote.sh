set -euo pipefail
analysis_dir=/fsx/analysis_results/ubuntu/ccv20260530r48_complete_genomics_mgi_snv_concordance
repo_dir=/fsx/analysis_results/ubuntu/ccv20260530r48_complete_genomics_mgi_snv_concordance/daylily-omics-analysis
echo '=== status ==='
