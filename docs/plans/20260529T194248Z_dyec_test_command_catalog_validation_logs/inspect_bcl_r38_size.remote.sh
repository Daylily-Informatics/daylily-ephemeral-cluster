...
analysis_id=ccv20260529r38_illumina_bclconvert
...
echo "=== bcl log tail ==="
tail -n 100 results/runs/20260514_LH01106_0009_B23TVLGLT4/bclconvert/logs/run_bclconvert.log 2>/dev/null || true
