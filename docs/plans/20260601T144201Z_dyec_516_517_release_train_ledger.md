...
| DYEC516-004 | First DYEC release | Commit, push branch, create annotated tag `5.1.16`, verify tag type, and push tag. | OPEN | release | Gate 6 | Codex |  |  |  |
| DYEC517-001 | Final self-pin | After `5.1.16`, update DYEC internal self-pins from `5.1.16` to `5.1.17`. | OPEN | config_or_startup_contract | Gate 6 | Codex |  |  |  |
| DYEC517-002 | Final validation | Re-run focused validation for final self-pin and package metadata. | OPEN | contract_test | Gate 6 | Codex |  |  |  |
