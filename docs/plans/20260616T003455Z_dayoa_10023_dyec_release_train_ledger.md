...
| REL-004 | DYEC first release | Commit, push, and annotated-tag DYEC after DayOA `10.0.23` pin and manifest | IN_PROGRESS | release_train | Gate 2 | Planned tag `10.0.37` | Pending commit, tag, and push. |
| REL-005 | DYEC self pin | Update DYEC self pins after first DYEC release | OPEN | release_train | Gate 3 | Planned self pin `10.0.37` and final tag `10.0.38` | Pending. |
| REL-006 | Final verification | Verify tests, clean git state, annotated tags, pushed branch/tags, and manifest summary | OPEN | acceptance | Gate 5 | Pending | Pending. |
