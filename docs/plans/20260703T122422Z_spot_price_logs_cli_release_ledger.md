...
| REL-002 | DYEC DayOA pin | Update DYEC DayOA pins to the new DayOA tag, commit, push, tag and push next DYEC version | OPEN | release | Gate 7 | Codex | Pending. |  |  |
| REL-003 | DYEC self-pin | Update DYEC self-pinned runtime version to the DYEC DayOA-pin tag, commit, push, tag and push final DYEC version | OPEN | release | Gate 7 | Codex | Pending. |  |  |
