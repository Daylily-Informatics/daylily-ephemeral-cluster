...
dyec tests command-catalog \
  ...
  --output-dir docs/plans/20260707T174440Z_dyec_tests_command_catalog_kitchensink_fix_logs \
  --stamp 20260707T174440Z \
  --timeout-minutes 720 \
  --poll-interval-seconds 60 \
  --catalog-config docs/plans/20260707T144453Z_dayoa4b26211_kitchensink_fix_command_catalog.yaml
