...
dyec tests command-catalog \
  ...
  --output-dir docs/plans/20260707T185605Z_dyec_tests_command_catalog_kitchensink_fix4_logs \
  --stamp 20260707T185605Z \
  --timeout-minutes 720 \
  --poll-interval-seconds 60 \
  --catalog-config docs/plans/20260707T144453Z_dayoa035f4dc_kitchensink_fix_command_catalog.yaml
