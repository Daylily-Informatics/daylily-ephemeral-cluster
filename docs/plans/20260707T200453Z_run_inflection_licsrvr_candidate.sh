...
dyec tests command-catalog \
  ...
  --output-dir docs/plans/20260707T200453Z_dyec_tests_command_catalog_inflection_licsrvr_candidate_logs \
  --stamp 20260707T200453Z \
  --timeout-minutes 720 \
  --poll-interval-seconds 60 \
  --catalog-config docs/plans/20260707T200453Z_dayoa4d29916_inflection_licsrvr_command_catalog.yaml
