...
dyec tests command-catalog \
  ...
  --profile lsmc \
  --region us-west-2 \
  --command-codes hybrid_ilmn_ont_snv_kitchensink \
  ...
  --output-dir docs/plans/20260707T203440Z_dyec_tests_command_catalog_hybrid_transfer_scratch_candidate_logs \
  --stamp 20260707T203440Z \
  --timeout-minutes 720 \
