...
- Planned DYEC final tag: `10.0.105`
...
| REL-003 | DYEC Dirty Release | Commit and push current dirty DYEC changes plus DayOA pin, then create/push annotated tag `10.0.104`. | IN_PROGRESS | release | Gate 5 | Codex | Pending commit/tag. |  |  |
| REL-004 | DYEC Self Pin | Update DYEC self pins to the final release version `10.0.105`. | OPEN | config_or_startup_contract | Gate 5 | Codex | Pending. |  |  |
| REL-005 | DYEC Final Release | Commit and push the self-pin release commit, then create/push annotated tag `10.0.105`. | OPEN | release | Gate 5 | Codex | Pending. |  |  |
