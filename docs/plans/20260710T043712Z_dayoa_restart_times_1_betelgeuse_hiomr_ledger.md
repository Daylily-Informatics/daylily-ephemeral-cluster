...
| MQC-RELEASE-001 | DayOA/DYEC | Publish follow-on releases that pin the Ganon/MultiQC contracts without changing active controllers. | IN_PROGRESS | feature_implementation | Gate 5 | orchestrator | DayOA commit `7192088`, annotated tag `10.0.80`, branch and tag pushed; DYEC pin updated to `10.0.80`; planned DYEC tags `10.0.136` and self-pin `10.0.137`. |  | DYEC publication pending. |
