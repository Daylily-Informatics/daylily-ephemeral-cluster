...
| MQC-RELEASE-001 | DayOA/DYEC | Publish follow-on releases that pin the Ganon/MultiQC contracts without changing active controllers. | SUCCESS | feature_implementation | Gate 5 | orchestrator | DayOA Ganon/MultiQC release `10.0.80` (`7192088`) and follow-up `10.0.81` (`40136d9`) were published with matching immutable DYEC release pairs. The final detected samples.tsv provenance guard passed the 486-test DayOA suite and was published as `10.0.82` (`52376e3`); DYEC catalogs/pins target `10.0.82`, 188 focused pin/catalog tests pass, and annotated tags `10.0.140`/self-pin `10.0.141` were created without moving prior tags. |  | Final superseding release train complete. |
...
- DayOA `10.0.82` is the final detected concurrent-change release; superseding DYEC tags `10.0.140`/`10.0.141` pin it. Earlier immutable DayOA and DYEC tags remain published and unmoved.
