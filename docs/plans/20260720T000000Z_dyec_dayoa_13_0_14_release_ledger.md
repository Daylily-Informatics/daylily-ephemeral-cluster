...
| REL-003 | DYEC self-pin | Update DYEC self-pin surfaces to `13.0.0`, commit, push, open PR, merge to `main`, sync local `main`. | IN_PROGRESS | config_or_startup_contract | Gate 1 | Codex | Self-pin edit pending test/commit |  |  |
