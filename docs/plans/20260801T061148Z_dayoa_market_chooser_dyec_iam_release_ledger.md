...
| DYEC-008 | DYEC | Publish the next free annotated DYEC release containing the fixed DayOA pin | OPEN | config_or_startup_contract | Gate 5 | orchestrator | Candidate `16.1.27`, subject to final remote recheck |  |  |
| DYEC-009 | DYEC | Advance the DYEC self-pin to DYEC-008 and publish the next free annotated release | OPEN | config_or_startup_contract | Gate 5 | orchestrator | Candidate `16.1.28`, subject to final remote recheck |  |  |
