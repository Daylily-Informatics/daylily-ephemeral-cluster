...
if [[ $# -ne 1 || ( "$1" != "dry" && "$1" != "live" ) ]]; then
  echo "usage: source take101_run_command.sh <dry|live>" >&2
...
take101_mode="$1"
take101_log="/fsx/analysis_results/preval-hiomr2/take101/daylily-omics-analysis/take101_hg002_na23687_fullcov_13.4.1_${take101_mode}_20260802.log"
take101_rc="/home/ubuntu/take101_hg002_na23687_fullcov_13.4.1_${take101_mode}_20260802.rc"
take101_extra=()
