...
| RPT-007 | Report | Produce `notes.md`, canonical `artifact.json`, portable `report.html`, source datasets/notes, and chart map in the requested Downloads directory | SUCCESS | feature_implementation | Report gate | orchestrator | Portable delivery receipt: validation/package/verification passed; 32 blocks, 4 charts, 14 tables; desktop and narrow viewport QA |  | Complete local artifact bundle includes per-sample/per-caller SMN12 and Truvari detail |
| RPT-008 | Hard copy | Convert the portable report to PDF, render every page, and visually verify legibility and layout | SUCCESS | contract_test | PDF QA gate | orchestrator | 12-page letter PDF; revised SMN12 and Truvari pages rendered and visually rechecked after table-width correction |  | Hard copy is legible without clipping |
...
## 2026-08-04 per-caller Truvari and SMN12 revision

- Added `take222_smn12_calls_by_caller.tsv` with eight explicit rows: four numeric SMNCopyNumberCaller calls and four completed Sentieon regional SMN1 VCF rows whose numeric CN fields are `NA_NOT_EMITTED`.
- Added `take222_truvari_results_by_caller.tsv` with 40 explicit sample/query rows. Jasmine and the public HG002 gate retain warning/not-applicable receipts with no attempted command and no metrics; Manta, Dysgu, TIDDIT, LongReadSV, Sniffles2, Severus, SURVIVOR, and OctopuSV are explicitly marked as having no per-caller Truvari artifact rather than zero performance.
- Added source-caller and merger/query matrices to the Markdown, portable HTML, and PDF. Portable validation, packaging, source interaction, desktop QA, and 390-pixel responsive QA all passed.
- Revised hard copy: 12 letter pages. The affected SMN12 and Truvari pages were rendered at 110 DPI and visually verified after shortening display-only status labels; the detailed TSV values remain lossless.
- Revised SHA-256: `notes.md` `725d6951eb795b5c0dbf06df8bfea353c371b62e54e7e3fabc5b8decefc67894`; `report.html` `cdcb83b012527c9a246a493fca1931ae4f7af0560f2bbab0bd8d8badff226614`; `report.pdf` `d70d65cf49881fd617e099ad38f8d9da6bca5e720d9776bb0cb0fe4c9435f05e`; `artifact.json` `e9b2e3605321512ae082bff89037bbefc72e05216a13e536fd3754b6733757e0`; SMN caller TSV `ff855ff34ab0f4bf041bbcef14c5b2b07f1b7e970270ec5de1d6616745238587`; Truvari caller TSV `37e5e24e93f791d6d266c717e3251882263e5af87bab36e3caf315564aa58038`.
