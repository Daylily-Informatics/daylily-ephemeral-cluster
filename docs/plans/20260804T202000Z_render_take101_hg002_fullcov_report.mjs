...
const root = "/Users/jmajor/Downloads/take101-hg002-fullcov-hiomr2-final-report";
const base = "TAKE101_HG002_NA23687_FULLCOV_HIOMR2_FINAL_REPORT";
...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  table { border-collapse: collapse; width: 100%; margin: 7px 0 13px; font-size: 6.6pt; table-layout: auto; break-inside: auto; }
  ...
  strong { color: #173f5f; }
`;
const html = `<!doctype html><html><head><meta charset="utf-8"><title>Take101 HG002 + NA23687 full-coverage HIOMR2 final report</title><style>${css}</style></head><body>${body}</body></html>`;
...
await page.pdf({
  ...
  footerTemplate: '<div style="font-size:7px;color:#647581;width:100%;text-align:center"><span class="pageNumber"></span> / <span class="totalPages"></span></div>',
  margin: { top: "0.52in", right: "0.52in", bottom: "0.58in", left: "0.52in" },
});
await browser.close();
