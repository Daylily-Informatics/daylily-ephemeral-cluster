...
| OVERLAY-006 | Immutable de novo release | Commit, tag, push, and self-pin the proven overlay command for newly created clusters | SUCCESS | Headnode-first Gate 5 | After live headnode proof, repair commit `e1adaa55...` / annotated tag `16.1.55` and self-pin release `16.1.56` were published; source and packaged de novo create defaults pin exactly `16.1.55` |
