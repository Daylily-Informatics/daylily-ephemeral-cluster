...
| DYEC-005 | Release provenance | Commit, push branch, annotate next unused DYEC tag, and verify remote tag objects. | SUCCESS | contract_test | Gate 5 | Release commit `e1a56a46ef06452126800ca43d306505c0805fce`; annotated tag object `1059c2bc995e20a4ca0b67aed2f94d5e5d94e154`; `origin` peeled tag ref resolves to the release commit. | Branch `codex/dyec-14.0.21-17.0.29` and immutable tag `17.0.29` are pushed. |

## Final acceptance

All DYEC ledger rows are terminal. `17.0.29` is a successor of immutable `17.0.28`, which already contains `17.0.18`; no redundant merge commit was created. No live workflow or infrastructure action was performed. The user explicitly stopped further test runs before release; the completed controller-entrypoint result and static catalog invariants above are the recorded verification boundary.
