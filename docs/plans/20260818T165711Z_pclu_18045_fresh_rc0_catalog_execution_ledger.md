...
| RUN-05 | Ultima Run-QC | `ultima_run_qc`, no basecalling. | IN_PROGRESS | active_product_contract | Gate 0 | run agent | Explicit Ultima DRA `dra-07fa4748941bd7d5d` verified `AVAILABLE`; dry `pclu18045_ultima_runqc_18047_15027_20260818t1825z` has been created from the exact catalog render. |
