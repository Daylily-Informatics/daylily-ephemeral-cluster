...
DAYOA_DEFAULT_TAG = "14.0.4"
DAYOA_VALIDATED_TAG = "14.0.4"
DAYOA_HIGHEST_RELEASE_COMMIT = "b2d79181e8589a06f29901fadc25be172f259eb8"
ONT_DAYOA_TAG = "14.0.4"
ONT_DAYOA_RELEASE_COMMIT = "b2d79181e8589a06f29901fadc25be172f259eb8"
...
def test_catalogs_and_dyec_repository_config_are_lsmc_bio_pinned() -> None:
    ...
    for relative_path in (
        ...
        assert data["dyec_builds"]["17.0.3"]["dayoa_git_tags"] == [DAYOA_DEFAULT_TAG]
        assert data["dyec_builds"]["current"] == data["dyec_builds"]["17.0.3"]
