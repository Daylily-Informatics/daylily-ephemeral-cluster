...
DAYOA_DEFAULT_TAG = "14.0.9"
DAYOA_VALIDATED_TAG = "14.0.9"
DAYOA_HIGHEST_RELEASE_COMMIT = "f4c7aa7e15f7dca602059097cb2314f96f05a826"
ONT_DAYOA_TAG = "14.0.9"
ONT_DAYOA_RELEASE_COMMIT = "f4c7aa7e15f7dca602059097cb2314f96f05a826"
...
def test_catalogs_and_dyec_repository_config_are_lsmc_bio_pinned() -> None:
    ...
    for relative_path in (
        ...
        assert data["dyec_builds"]["17.0.7"]["dayoa_git_tags"] == [DAYOA_DEFAULT_TAG]
        assert data["dyec_builds"]["17.0.8"]["dayoa_git_tags"] == [DAYOA_DEFAULT_TAG]
        assert data["dyec_builds"]["current"] == data["dyec_builds"]["17.0.8"]
