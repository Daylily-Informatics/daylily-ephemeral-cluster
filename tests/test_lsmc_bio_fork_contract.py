...
DAYOA_DEFAULT_TAG = "14.0.8"
DAYOA_VALIDATED_TAG = "14.0.8"
DAYOA_HIGHEST_RELEASE_COMMIT = "ef285dc06be4b57d4a388e8b791e70f4131cff92"
ONT_DAYOA_TAG = "14.0.8"
ONT_DAYOA_RELEASE_COMMIT = "ef285dc06be4b57d4a388e8b791e70f4131cff92"
...
def test_catalogs_and_dyec_repository_config_are_lsmc_bio_pinned() -> None:
    ...
    for relative_path in (
        ...
        assert data["dyec_builds"]["17.0.6"]["dayoa_git_tags"] == [DAYOA_DEFAULT_TAG]
        assert data["dyec_builds"]["current"] == data["dyec_builds"]["17.0.6"]
