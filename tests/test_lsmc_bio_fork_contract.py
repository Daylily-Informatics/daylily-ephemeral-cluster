...
DAYOA_DEFAULT_TAG = "14.0.16"
DAYOA_VALIDATED_TAG = "14.0.16"
BJUICE_V2_DAYOA_TAG = "14.0.16"
DAYOA_HIGHEST_RELEASE_COMMIT = "ab8a66afa65a62b4d447ce583c9e44855b6be6dc"
ONT_DAYOA_TAG = "14.0.16"
ONT_DAYOA_RELEASE_COMMIT = "ab8a66afa65a62b4d447ce583c9e44855b6be6dc"
...
def test_catalogs_and_dyec_repository_config_are_lsmc_bio_pinned() -> None:
    ...
    for relative_path in (
        ...
        assert data["dyec_builds"]["current"] == data["dyec_builds"]["17.0.18"]
