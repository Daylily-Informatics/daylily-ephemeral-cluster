...
DAYOA_DEFAULT_TAG = "14.0.13"
DAYOA_VALIDATED_TAG = "14.0.13"
DAYOA_HIGHEST_RELEASE_COMMIT = "89bbbee98eb84215f2651273c1a48c65c9ee5fca"
ONT_DAYOA_TAG = "14.0.13"
ONT_DAYOA_RELEASE_COMMIT = "89bbbee98eb84215f2651273c1a48c65c9ee5fca"
...
def test_catalogs_and_dyec_repository_config_are_lsmc_bio_pinned() -> None:
    ...
    for relative_path in (
        ...
        assert data["dyec_builds"]["17.0.11"]["dayoa_git_tags"] == [DAYOA_DEFAULT_TAG]
        assert data["dyec_builds"]["current"] == data["dyec_builds"]["17.0.11"]
