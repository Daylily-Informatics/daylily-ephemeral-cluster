...
DYEC_RELEASE = "19.0.22"
PREVIOUS_DYEC_RELEASE = "19.0.21"
DAYOA_RELEASE = "16.0.5"
...
def test_19_0_22_uniformly_pins_dayoa_16_0_5() -> None:
...
def test_19_0_22_preserves_19_0_21_and_retargets_only_new_snapshot() -> None:
    raw = _catalog()
