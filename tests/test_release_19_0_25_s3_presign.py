...
from daylily_ec.aws.s3_presign import MAX_PRESIGN_EXPIRATION_SECONDS
...
DYEC_RELEASE = "19.0.25"
PREVIOUS_DYEC_RELEASE = "19.0.24"


def test_19_0_25_preserves_the_19_0_24_catalog_snapshot() -> None:
...
def test_19_0_25_exposes_bounded_read_only_s3_presign() -> None:
    command = app._cli_core_yo_registry.get_command(("aws", "s3", "presign"))
    ...
    assert MAX_PRESIGN_EXPIRATION_SECONDS == 604800


def test_19_0_25_documents_the_public_presign_route() -> None:
    ...
    assert "dyec --json aws s3 presign" in guide
    assert "dyec --json aws s3 presign" in reference
