...
def test_repository_catalog_commands_have_run_metadata() -> None:
    ...
    assert package_inflection.validated_version == "13.0.59"
    assert package_inflection.git_tag == "13.0.59"
...
def test_repository_catalog_run_analysis_commands_require_run_context() -> None:
    ...
    assert ultima.validated_version == "13.0.59"
    assert ultima.git_tag == "13.0.59"
