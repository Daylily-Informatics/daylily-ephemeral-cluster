...
class TestLoadConfig:
    ...
    def test_load_template_file(self):
        ...
        assert ec.config["fsx_deployment_type"].action == "PROMPTUSER"
        assert ec.config["fsx_deployment_type"].default_value == "PERSISTENT_2"
        assert ec.config["fsx_deployment_type"].set_value == ""
        assert ec.config["fsx_fs_size"].action == "PROMPTUSER"
